        ...
        subProjects: [
          {
            ...
            contributions: [
              "Claude Code 기반 AI 개발 환경 구축 — CLAUDE.md 계층 2단과 문서 규약을 설계해 팀의 기획·리뷰·개발 기록이 동일한 구조로 축적되도록 표준화",
              "반복 운영 작업을 커스텀 Skill로 자동화 — 데이터 수집 사이클러(cron), 수집 산출물의 MongoDB 적재, Jira ↔ 문서 양방향 동기화",
              "PRD 필수 항목 검증·QA 체크리스트 생성 Agent를 만들어 문서 품질 게이트 구성",

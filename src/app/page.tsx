        ...
        subProjects: [
          {
            ...
            achievements: [
              "인스타그램 계정을 연결해 실제 운영 중인 곳 800여 곳, 누적 1,258만 건의 댓글 데이터를 수집·처리",
          ...
          },
          {
            ...
            achievements: [
              "유료 고객의 52%가 자동 DM을 사용 중이며, 서비스 전체 자동 발송의 65%가 유료 고객에게서 발생",
          ...
          },
          {
            ...
            contributions: [
              ...
              "생성 결과를 그대로 믿지 않도록 수집 전·후 검증 단계를 따로 두어 데이터 품질을 판정",
            ...
            achievements: [
              ...
              "실행 환경(로컬·클라우드)에 따라 호출 경로를 자동으로 나눠, 자동화가 불필요한 과금을 태우지 않도록 차단",
            ],
          },
          {

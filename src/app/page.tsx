        ...
        subProjects: [
          {
            ...
            contributions: [
              "Claude Code 기반 개발 환경 구축 — CLAUDE.md 계층과 PRD·회고·history 이관 규약을 설계해, 담당자가 바뀌어도 의사결정 맥락이 복원되는 문서 체계 확보",
              "반복 운영 작업을 커스텀 Skill·Agent로 자동화 — 수집 사이클러(cron), MongoDB 적재, Jira 양방향 동기화, PRD·QA 검증 게이트",

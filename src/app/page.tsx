      ...
      <section className="mb-16">
        ...
        <div className="space-y-4 text-foreground/80 leading-relaxed sm:text-base">
          <p className="pl-1">
            ...
            8년간 프론트엔드를 중심으로 물류 현장의 운영 시스템부터 마케팅
            자동화 플랫폼까지, 유저의 문제를 화면에서 가장 먼저 찾아
            풀어왔습니다. 지금은 Claude Code 기반 AI 워크플로를 직접 만들어
            쓰면서 백엔드·데이터 파이프라인·LLM 파이프라인, 인프라까지 혼자
            감당하는 범위를 넓혔고, 빠르게 배포하고 지표를 보며 다음 개선을
            정합니다.
          </p>
        </div>
      </section>

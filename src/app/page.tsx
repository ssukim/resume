    ...
    items: [
      {
        ...
        subProjects: [
          ...
          },
          {
            ...
            period: "2026.05 ~ 현재",
            problem: "고객에게 보내는 주간·월간 리포트를 사람이 매번 손으로 만들고 있었고, 해설 문장을 AI에게 맡겨도 계정당 2분씩 걸려 계정이 늘수록 감당이 안 되던 상황",
            ...
            contributions: [
              ...
              "품질이 검증되기 전까지는 클라우드 비용 없이 로컬에서 돌리며 실험하고, 검증된 뒤 매일 정해진 시각에 자동 실행되도록 클라우드로 이관",
              "유료 고객은 클라우드, 무료·체험 유저는 로컬로 생성을 분담해 클라우드 비용이 매출과 연동되도록 설계 (현재 클라우드 74계정 · 로컬 234계정)",
              "유저가 기간을 골라 요청하면 대기열에 쌓아 순서대로 처리 — 요금 차감·예외 상황까지 자동 반영",
            ],
            achievements: [
